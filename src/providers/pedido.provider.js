...
var PedidoProvider = (function () {
    function PedidoProvider(http) {
        this.http = http;
        this.baseUrl = 'https://cria-backend.herokuapp.com/pedidos';
    }
    PedidoProvider.prototype.getDetails = function () {
        return this.http
            .get("" + ENV.BASE_URL + ENV.DETAIL_EP)
            .pipe(map(function (details) { return details.data; }));
    };
